            ...
            <div class="navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-language nav-item"><a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="selected-language">{{ config('app.languages.'.app()->getLocale()) }}</span></a>
                        <div class="dropdown-menu" aria-labelledby="dropdown-flag">
                          <a class="dropdown-item" href="{{ url()->current() }}?lang=en" data-language="en"> English</a>
                          <a class="dropdown-item" href="{{ url()->current() }}?lang=bn" data-language="bn"> বাংলা</a>
                        </div>
                    </li>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                          ...
                          <span class="badge badge-pill badge-primary badge-up">{{ auth()->user()->notifications->count() }}</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <div class="dropdown-header m-0 p-2">
                                    <h3 class="white">{{ auth()->user()->notifications->count() }} New</h3>
                                ...
                                <a class="d-flex justify-content-between" href="#">
                                  <div class="media d-flex align-items-start">
                                    ...
                                    <div class="media-body">
                                      <h6 class="primary media-heading">{{ $notification->data['data']['title'] }}</h6>
                                      <small class="notification-text"> {{ $notification->data['data']['description'] }}</small>
                                    </div>
                                    <small>
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ auth()->user()->profileUrl }}">
                              <i class="feather icon-user"></i> Profile
                            </a>
                            <a class="dropdown-item" href="/profile/reset-password">
