...
@section('title', 'Account Types: Create New Account Type')
  ...
  <div id="basic-examples">
    <div class="card">
        <div class="card-header">
          <h4 class="card-title">Create New Account Type</h4>
        </div>
        <div class="card-content collapse show">
          <div class="card-body">
            <form action="{{ route('api.account-types.store') }}" id="account_type_create_form" method="POST" autocomplete="off">
                {{ csrf_field() }}
                <div class="row">
